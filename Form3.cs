...
namespace aimtrain
{
    public partial class Form3 : Form
    {
        public Form3()
        {
            ...
            label1.Location = new Point(this.Width - button1.Width - 7, this.Height / 2 - label1.Height - 5 - label2.Height/2);
            label2.Location = new Point(this.Width - button1.Width - 7, this.Height / 2 - label2.Height/2);
            label3.Location = new Point(this.Width - button1.Width - 7, this.Height / 2 + 5 + label2.Height / 2);
            label1.Text = "0";
            label2.Text = "0";
            label3.Text = "0";
        }
